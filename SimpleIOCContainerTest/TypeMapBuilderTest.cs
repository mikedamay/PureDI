...
namespace IOCCTest
{
    ...
    public class TypeMapBuilderTest
    {
        ...
        private static void CompareMaps(IWouldBeImmutableDictionary<(Type, string), Type> map
          , IDictionary<(string, string), string> mapExpected)
        {
    ...
    internal static class MapExtensions
    {
        ...
        public static string OutputToString(this IWouldBeImmutableDictionary<(Type type, string name), Type> map)
        {
            StringBuilder sb = new StringBuilder();
            void AddMapEntry((Type type, string name) key)
            {
